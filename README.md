...
- Nominate command (!nom / !nominate). Nominate a map to appear in the vote. Partial name matching, and conflicting map name resolution (surf_beginner, surf_beginner2). Configurable limit per player.
